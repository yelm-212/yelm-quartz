...
OSTEP 목차를 기준으로 가상화, 병행성, 영속성을 각각 2주씩 학습한 기록입니다.

> 전체 일정과 진행 방식은 [CS 학습 계획](01_Project/12_week_cs_study)에서 관리합니다.

## 학습 원칙

- 주차별 OSTEP 챕터 범위는 고정한다.
- 강의, 공식 문서, 다른 책을 사용해도 해당 챕터의 주제와 범위를 모두 다룬다.
...
- 학습 내용: [I/O와 파일 시스템 기초](03_Resource/05_os/09_persistence_io_storage)
- 인사이트: [I/O와 파일 시스템 기초 인사이트](03_Resource/05_os/10_persistence_io_storage_insight)

### 10주차 - 영속성 2: OSTEP Ch 41~51

- 학습 내용: [파일 시스템 복구와 데이터 무결성](03_Resource/05_os/11_persistence_filesystems)
- 인사이트: [파일 시스템 인사이트](03_Resource/05_os/12_persistence_filesystems_insight)

### 추가 범위 - Security: OSTEP Ch 52~57

- 학습 내용: [OSTEP Security](03_Resource/05_os/13_security)
